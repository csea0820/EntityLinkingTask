...
public abstract class AbstractLinking extends DefaultHandler {
	...
	private Set<String> query(String query)
	{
		...
		Set<String> candidates = senseGenerator(query.toLowerCase());
...
//				continue;
			...
			Utility.writeToFile(outputPath+"\\"+elr.getQueries().get(i)+"_"+elr.getExpectedResult().get(i)+"_"+i+".txt", sb.toString());
